# Planned learning-model extensions

These features have been discussed but are not implemented in the current site:

- Missing first or second addends alongside missing-result exercises.
- A teacher lesson after trial 100 (first use on trial 101) introducing the missing-addend draw-and-match procedure.
- Conditional lessons triggered when a configurable error-rate threshold is met over a minimum number of relevant attempts.
